        ...
        <v-row>
          ...
          <v-col cols="12" lg="4">
            <v-card elevation="2" class="pa-4">
              ...
              <v-card 
                ...
                class="pa-3"
              >
                <v-card-title class="pa-0 pb-2 text-subtitle-1">Dataset Statistics</v-card-title>
                <v-row dense>
                  <v-col cols="6">
          ...
          <v-col cols="12" lg="8">
            <v-card elevation="2" class="pa-4" style="height: calc(100vh - 120px);">
              ...
              <!-- Results List -->
              <div v-if="results.length > 0" style="height: calc(100vh - 200px); overflow-y: auto;">
                <v-virtual-scroll
                  :items="results"
                  height="100%"
                  item-height="120"
...
const getDisplayTitle = (item: any) => {
  return item.title?.value || 
         item.resource?.value?.split('/').pop() || 
         'Untitled';
};

const getDisplaySubtitle = (item: any) => {
  return item.creator?.value?.split('/').pop() || 
